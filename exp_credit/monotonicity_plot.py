...
# monot_buf_buf = torch.cat(monot_buf_buf, dim=0)
...
plt.savefig("../figure/faithful_vs_n_sample_credit.pdf")
...
plt.xlim([2.96, 7.04])
plt.grid()
plt.subplots_adjust(left=0.16 , bottom=0.13, top=0.99, right=0.99, wspace=0.01)
plt.savefig("../figure/monot_vs_n_sample_credit.pdf")
