...
checkpoint_buf_wo_softmax = {
    "SHEAR":[
        "../credit-dataset/wo_softmax/efficient_shap_credit_m_1_s_4_r_0_c_1.pth.tar",
        ...
        "../credit-dataset/wo_softmax/efficient_shap_credit_m_1_s_192_r_0_c_1.pth.tar",
        "../credit-dataset/wo_softmax/efficient_shap_credit_m_1_s_256_r_0_c_1.pth.tar",
    ],
    "KernelShap":[
    ...
    "PS":[
        ...
        "../credit-dataset/wo_softmax/permutation_credit_m_1_s_192_r_0_c_1.pth.tar",
    ],
    "APS":[
...
# plt.grid()
# plt.subplots_adjust(left=0.15 , bottom=0.12, top=0.99, right=0.98, wspace=0.01)
# plt.savefig("../figure/mAP_vs_time_credit.pdf")
#
# plt.show()
...
plt.grid()
plt.subplots_adjust(left=0.14 , bottom=0.13, top=0.99, right=0.99, wspace=0.01)
plt.savefig("../figure/Throughput_vs_ACC_credit.pdf")
