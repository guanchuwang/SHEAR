...
if __name__ == "__main__":
    ...
    round_num = 0
    datasets_torch, cate_attrib_book, dense_feat_index, sparse_feat_index = load_data('./credit-dataset/bank-full-dataset.csv', val_size=0.2, test_size=0.2, run_num=round_num) #
    ...
    # save_checkpoint("./credit-dataset/model_credit_m_1_r_" + str(round_num) + ".pth.tar",
